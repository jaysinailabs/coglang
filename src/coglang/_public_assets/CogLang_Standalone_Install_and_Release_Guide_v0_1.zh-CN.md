...
stable `v1.1.0` 让 Python distribution version 与语言 release 对齐（tag `v1.1.0` 对应包版本 `1.1.0`）。
...
stable `v1.1.0` 让这两层有意收敛：GitHub tag 是 `v1.1.0`，Python 包版本是 `1.1.0`，`language_release` 报告 `v1.1.0`。
